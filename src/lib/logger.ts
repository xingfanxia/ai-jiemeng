 ...
 *   (555) 123-4567 -> (555) ***-****
 *   5551234567 -> 555***4567
 *   13812345678 -> 138****5678 (Chinese mobile)
 */
export function maskPhone(phone: string): string {
  // Chinese mobile: 1XX XXXX XXXX
  const chineseRegex = /^(1\d{2})\d{4}(\d{4})$/;
  let match = phone.match(chineseRegex);
  if (match) {
