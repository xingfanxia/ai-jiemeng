...
| 措施 / Measure | 说明 / Description |
|---------------|---------------------|
| **管理员无权查看原文** | 后台管理员**无法**查看用户对话原文内容 / Backend administrators **cannot** view original user conversation content |
...
| **不训练模型** | 我们**不**使用您的数据训练任何AI模型 / We do **NOT** use your data to train any AI models |
...
|------------------|----------------|---------------------------|
| **Google (Gemini)** | 主要对话AI / Primary conversation AI | [Google Privacy Policy](https://policies.google.com/privacy) |
| **Anthropic (Claude)** | 高级对话AI / Premium conversation AI | [Anthropic Privacy Policy](https://www.anthropic.com/privacy) |

### 2.2 数据处理方式 / How Data is Processed

- **对话传输**: 您的对话内容会被发送至上述AI服务进行处理
- **不用于训练**: 我们通过API调用AI服务，您的数据**不会**被用于训练这些AI模型
...
1. **提供服务**: 进行性格测评、生成分析报告
2. **账户管理**: 维护您的账户和测评历史
3. **服务改进**: 分析使用模式以改进服务质量
4. **技术支持**: 响应您的问题和反馈
5. **安全保护**: 检测和防止欺诈、滥用行为
6. **合规要求**: 遵守适用法律法规

1. **Service Delivery**: Conduct personality assessments, generate analysis reports
2. **Account Management**: Maintain your account and assessment history
3. **Service Improvement**: Analyze usage patterns to improve service quality
4. **Technical Support**: Respond to your questions and feedback
5. **Security**: Detect and prevent fraud and abuse
